...
namespace CapaPresentacion
{
    public partial class Inicio : Form
    {
        ...
        {
            AbrirFormulario(VentasMenu, new frmDetalleVenta());
        }
        ...
        {
            AbrirFormulario(ComprasMenu, new frmDetalleCompra());
        }
        ...
        {
            AbrirFormulario(ReportesMenu, new frmReporteCompras());
        }

        private void submenureporteventas_Click(object sender, EventArgs e)
        {
            AbrirFormulario(ReportesMenu, new frmReporteVentas());
        }
