...
namespace Punto_de_venta
{
    public partial class FRMDetalleCompras : Form
    {
        ...
        private void btndescargar_Click(object sender, EventArgs e)
        {
             ...
             * Texto_Html = Texto_Html.Replace("@montototal",txtmontotoal.Text);
             * 
             ...
             *      {
             *          Document pdfDoc = new Document(PagSize.A4,25,25,25,25);
             *          
             ...
             *          pdfDoc.Close();
             *          stream.Close();
             *          MassageBox.Show("Documento Generado","Mensaje",MassageBoxButtons.OK,MassageBoxIcon.Infomation)
             *          
             *      }
             * }
            */
